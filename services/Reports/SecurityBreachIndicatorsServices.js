...
// @access    Public
exports.getSecurityBreachIndicators = factory.getOne(SecurityBreachIndicators);

// @desc      Get List Of Non Compliance Gaps Overview
// @route     GET /api/executive-dashboard/security-breach-indicators
// @access    Public
exports.getSecurityBreachIndicatorss = factory.getAll(SecurityBreachIndicators);
